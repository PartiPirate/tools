...
<br>
	<div>	
		<a href="https://discord.gg/vkjw5GS" title="<?php echo lang("sso_mumble"); ?>" data-toggle="tooltip" data-placement="bottom"
			target="_blank" class="btn btn-external col-md-2" style="height: 70px; padding: 25px 0 0 0; margin-left: 10px; margin-right: 10px; float: none;">Discord</a>
